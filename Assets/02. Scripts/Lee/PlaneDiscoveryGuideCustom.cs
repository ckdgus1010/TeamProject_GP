...
/// </summary>
public class PlaneDiscoveryGuideCustom : MonoBehaviour
{
    /// <summary>
    /// The time to delay, after ARCore loses tracking of any planes, showing the plane discovery guide.
    /// </summary>
    ...
    /// <summary>
    /// The time to delay, after displaying the plane discovery guide, offering more detailed instructions on how to find a plane.
    /// </summary>
